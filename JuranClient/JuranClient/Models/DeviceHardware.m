...
+ (CGFloat)deviceWidth{
    if ([DeviceHardware generalPlatform] == DeviceHardwareGeneralPlatform_iPhone_6) {
        return 750;
    }else if ([DeviceHardware generalPlatform] == DeviceHardwareGeneralPlatform_iPhone_6_Plus){
        return 1080;
    }
