 ...
 */
@interface ALWebView : UIView <UIWebViewDelegate>
 ...
 */
@property (nonatomic, assign) id<ALWebViewDelegate> delegate;
 ...
 */
- (void)webViewDidStartLoadingPage:(ALWebView *)aWebView;
...
/**
 ...
 @see webViewDidFinishLoadingPage:
 */
- (void)webViewDidLoadDOM:(ALWebView *)aWebView;
 ...
 */
- (void)webViewDidFinishLoadingPage:(ALWebView *)aWebView;
 ...
 */
- (BOOL)webView:(ALWebView *)aWebView shouldStartLoadWithRequest:(NSURLRequest *)aRequest navigationType:(UIWebViewNavigationType)navigationType;
