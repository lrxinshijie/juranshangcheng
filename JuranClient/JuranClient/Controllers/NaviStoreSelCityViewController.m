//
//  NaviStoreSelCityViewController.m
//  JuranClient
//
...
@interface NaviStoreSelCityViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger type;
...
@implementation NaviStoreSelCityViewController
